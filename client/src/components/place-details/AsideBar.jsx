...
const AsideBar = ({ activeLink, setActiveLink, fixedClass }) => {
  ...
  return (
    <aside className="relative xl:col-span-1 xl:flex flex-col hidden bg-transparent -mt-3 mb-12">
      ...
      <div className="relative card w-full h-60 bg-gray-700 border-1 border-gray-600 p-6 rounded-3xl shadow-xl ml-20 -me-10">
